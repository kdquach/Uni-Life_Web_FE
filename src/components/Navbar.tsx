...
export default function Navbar({ onSearch }: NavbarProps) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-[0_12px_40px_rgba(0,0,0,0.08)] px-6 py-4 flex items-center justify-between mb-6">
      <div className="flex items-center gap-4 flex-1">
        ...
        <div className="flex-1 max-w-md relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3 bg-gray-50 rounded-xl border-none outline-none focus:ring-2 focus:ring-orange-500 transition-all"
        ...
        {isAuthenticated && user ? (
          <div className="relative" ref={dropdownRef}>
            <button
              ...
              className="flex items-center gap-2 hover:bg-gray-50 rounded-lg p-1 pr-3 transition-colors"
            >
